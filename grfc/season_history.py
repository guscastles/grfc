...
from . import scheduler as sc


# Get the goals for each match
def read_raw_data(filename):
    return [sc.read_data_file(filename, f'Round {nbr}').iloc[15:, 2:4] for nbr in range(1, 9)]
...
def match_results(scoreboard):
    ...
    return [__result__(score) for score in scoreboard] 
